...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Start = __webpack_require__(222);

	var _Start2 = _interopRequireDefault(_Start);

	var _Play = __webpack_require__(223);

	var _Play2 = _interopRequireDefault(_Play);

	var _End = __webpack_require__(226);

	var _End2 = _interopRequireDefault(_End);

	var _CommandParser = __webpack_require__(224);
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'p',
						null,
						'You\'re not quite sure how you got to this point, but you\'re pretty sure it\'s someone at Mission Control\'s fault. '
					),
					_react2.default.createElement(
						'p',
						null,
						'Well, they can\u2019t help you now. As long as you can pilot your way to safety in the next few minutes, you\'ll survive. Just don\u2019t let the faint smell of smoke panic you.'
					),
					_react2.default.createElement(
						'p',
						null,
						'Sure, you\u2019ve been forced into manual mode, which you haven\u2019t used since you were a lowly flight student, but that just means you\u2019ll have to RTFM.'
					),
					_react2.default.createElement(
						'a',
						{ href: 'http://www.cs.utexas.edu/~asma/manual.pdf', download: true },
						'Download Manual'
					),
					_react2.default.createElement(
						'p',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Console = function (_React$Component) {
	  ...
	  function Console(props) {
	    ...
	    _this.state = { consoleHistory: ["ASTEROID IMPACT DAMAGE: HIGH", "CURRENT STATUS: FREE FALL", "AUTOPILOT TURNED OFF TO MINIMIZE POWER COST", "PLEASE ACTIVATE EMERGENCY_LANDING_MODE", "(If you need a hint, enter HELP!)"], value: '' };

	    _this.displayInput = _this.displayInput.bind(_this);
	  ...
	  _createClass(Console, [{
	    key: 'displayInput',
	    value: function displayInput(event) {
	      this.setState({ value: event.target.value });
	    }
	  }, {
	    key: 'processInput',
	    value: function processInput(event) {
	      if (_CommandParser.endgame == true) {
	        _reactRouter.browserHistory.push('/end');
	      }
	      var consoleHistory = this.state.consoleHistory;
	      var textList = (0, _CommandParser.CommandParser)(this.state.value);
	      this.setState({
	        value: '',
	    ...
	    value: function render() {
	      var consoleHistory = this.state.consoleHistory;
	      var consolelog = consoleHistory.map(function (commands, index) {
	        return _react2.default.createElement(
	          'p',
	          { key: index },
	          commands
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { onSubmit: this.processInput, id: 'consolesubmit' },
	          _react2.default.createElement(
	            'label',
	            null,
	            _react2.default.createElement('input', { type: 'text', autofocus: 'autofocus', value: this.state.value, onChange: this.displayInput })
	          ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.endgame = exports.CommandParser = undefined;

	var _Hints = __webpack_require__(225);
	...
	*/
	...
	function CommandParser(command) {
		...
		if (commandtokens[0] == "HELP") {
			if (_Hints2.default[environment.currentStep].length - 1 > hintlevel) {
				hintlevel++;
			}
			return _Hints2.default[environment.currentStep][hintlevel];
	...
	*/
	var programList = {
		"STANDARD_SPACESHIP_STATISTICS": function STANDARD_SPACESHIP_STATISTICS() {
			...
			environment.program = null;
			return ["STANDARD SPACESHIP STATISTICS", "CURRENT STATUS: FREE FALL", "CURRENT POWER LEVEL: VERY LOW", "VELOCITY: 70 LYMP", "OXYGEN LEVELS, WITHIN SPACESHIP: MEDIUM", "OXYGEN LEVELS, OUTSIDE SPACESHIP: NONEXISTENT", "CURRENT LIKELIHOOD OF SURVIVAL: EXTREMELY LOW"];
		},
		"EMERGENCY_LANDING_MODE": function EMERGENCY_LANDING_MODE() {
			...
			if (environment.isBackupInstalled && !environment.gaveModePin) {
				...
				environment.program = null;
				return ["EMERGENCY LANDING MODE ACTIVATED.", "CORRUPTED COMPONENT DETECTED.", "PLEASE RUN EMERGENCY_LANDING_MODE_BACKUP AND TRY AGAIN."];
			}
		},
		"EMERGENCY_LANDING_MODE_BACKUP": function EMERGENCY_LANDING_MODE_BACKUP() {
	...
	function ParseLandingMode(command) {
		if (commandtokens[0] == "EXT") {
			...
			if (commandtokens[0] == "70") {
				...
				return ["EMERGENCY LANDING WILL NOW COMMENCE IN", "3", "2", "1", "..............", "..............", ".............."];
				//TODO: jump to ending
			} else return ["UNEXPECTED VELOCITY DENIED. PLEASE TRY AGAIN."];
		}
	}
...
/***/ function(module, exports) {
	...
	var hints = {
		"runEmergencyLandingMode": ["Hm... how do I run a program, again? I better check the manual.", "I should be able to find the run command on the List of Commands page of the manual.", "Oh, I remember! It's \"exc emergency_landing_mode\"."],
		"runBackup": ["It looks like I might be the wrong directory.", "Hmm... I wonder if I can find anything useful in the Index.", "Okay, according to the Index, it looks like there are three directories. I wonder which one contains the backups?", "A Table of Contents is sort of like a directory, right? Let's try looking there for a hint.", "Backups is listed as a chapter of the Toolkits section in the Table of Contents.", "Okay, so how do I get out of here? If I remember correctly, there were some navigation commands in the List of Commands page...", "I've got it! \"u\", then \"e toolkit\" then \"exc emergency_landing_mode_backup\""],
		"modePIN": ["This looks like it's going to be harder. Is there any reference to a PIN anywhere in the manual?", "The second footnote of chapter two mentions a PIN! I can't really look up scholarly articles right now, though...", "I've figured it out! The References section lists a paper by Vido Gaem. I hope typing in 2030 works..."],
		"SSS": ["Let's see if I can find any references to velocity in the manual.", "The first footnote of chapter two references a file that contains the velocity! Now, what's it called...", "The footnote says to check chapter 4.3, p1049. Gah, if only I had the full manual! What can I even do with that information!", "The index has an entry for page 1049! Let's hope it's the file! But first, I'll have to exit the backup...", "Let's check the Command List again.", "Hm... which directory is it likely to be in? I wonder if Chapter 4.3 contains any hints...", "It's in the data directory!"]
...
/***/ function(module, exports, __webpack_require__) {
	...
	var End = function (_React$Component) {
	  ...
	  function End(props) {
	    ...
	    _this.state = { text: "Congratulations!", currentNumber: 0 };
	    _this.updateScreen = _this.updateScreen.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(End, [{
	    ...
	    value: function updateScreen() {
	      var textList = ["Congratulations!", "You have successfully completed: SPACESHIP PILOT EXAM: LEVEL 2.", "This earns you the rank of SPACESHIP NEWBIE and authorizes you to apply for the following positions: SPACE GARBAGE COLLECTOR.", "You may now attempt SPACESHIP PILOT EXAM: LEVEL 3.", "The next administration of this exam will take place in PLANET GGJ TESTING CENTER on JANUARY 25 2255.", "This test will consist of: MANUAL ENGINE FAILURE DIAGNOSIS with a time limit of 10 MINUTES and NO MANUAL OR SUPPLEMENTARY MATERIAL.", "Good luck!"];
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        { id: "endgame", onClick: this.updateScreen },
	        _react2.default.createElement(
	          "h2",
	          null,
	          this.state.text
